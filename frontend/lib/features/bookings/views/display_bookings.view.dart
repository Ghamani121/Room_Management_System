                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _detailRow(Icons.group, "Attendees", booking.attendees?.map((a) => a.name).join(", ") ?? "None"),
                      _detailRow(Icons.calendar_today, "Created At", booking.createdAt != null ? formatter.format(booking.createdAt!) : "-"),
                      _detailRow(Icons.update, "Updated At", booking.updatedAt != null ? formatter.format(booking.updatedAt!) : "-"),
                    ],
                  ),
                ),
              ),
